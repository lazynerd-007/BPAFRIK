...
export default function PartnerBankForgotPasswordPage() {
  return (
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-xs">
            <ForgotPasswordForm userType="partner-bank" />
          </div>
        </div>
      </div>
      <div className="bg-gradient-to-r from-emerald-600 to-teal-700 relative hidden lg:block">
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-10">
          ...
          <p className="text-center max-w-md mb-6">
            We&apos;ll help you reset your password and get back to managing your banking operations.
          </p>
